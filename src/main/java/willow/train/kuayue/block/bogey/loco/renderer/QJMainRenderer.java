...
public class QJMainRenderer extends KuayueBogeyRenderer {
    ...
    //渲染需要DTHITA值部件静态
    public static void staticPartialRender(BogeyModelData combinationLever, BogeyModelData combinationLeverOtherside,
                                           BogeyModelData steamValve, BogeyModelData steamValveOtherside,
                                           BogeyModelData radiusRod, BogeyModelData radiusRodOtherside,
                                           BogeyModelData oilPress, BogeyModelData oilPressOtherside,
                                           BogeyModelData oilPressRod, BogeyModelData oilPressRodOtherside,
                                           BogeyModelData reversingBoom, BogeyModelData reversingBoomOtherside,
                                           BogeyModelData reversing,
